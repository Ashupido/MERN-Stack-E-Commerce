    ...
    <div className="p-8">
      ...
      <DataTable
        ...
        data={orders.map((o) => ({
          ...
          total: <span className="font-bold text-emerald-400">${Number(o.totalAmount || 0).toFixed(2)}</span>, // Ensure totalAmount is a number
          ...
          actions: (
            ...
            >
              ...
              <option value="shipped">Shipped</option> {/* Corrected typo: "paid" was duplicated */}
